...
| AWS CodePipeline Infrastructure     | [src/aws_codepipeline.py](scr/aws-codepipeline.py) | [docs/aws_codepipeline_infrastructure.md](docs/aws_codepipeline_infrastructure.md)         | [diagrams/aws_codepipeline_infrastructure_with_cloudformation.png](diagrams/aws_codepipeline_infrastructure_with_cloudformation.png)         |
